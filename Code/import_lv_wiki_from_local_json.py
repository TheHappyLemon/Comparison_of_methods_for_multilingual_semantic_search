...
def flush_data(data : list, has_flushed : bool):
    ...
    with open(path_res + 'results_cirrussearch.csv', 'a', encoding="utf-8") as csvfile:
        if not has_flushed:
        ...
        for page in data:
            ...
            with open(path_res + f"lv_cirrussearch\\{page['file_name']}", 'w', encoding="utf-8") as txtfile: 
