...
python3 $HOME/Comparison_of_methods_for_multilingual_semantic_search/Code/generate_embeddings_transformers.py
cp "$DIR/Dataset/embeddings.hdf5" "$HOME/embeddings_result_transformers.hdf5"
cp "$DIR/generate_embeddings_transformers.log" "$HOME/generate_embeddings_transformers_result.log"
